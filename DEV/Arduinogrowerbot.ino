...
String growName = "HVC's Garden";
String sourceName = "";
String sourceVariety = "Tomatos and Basil";
String apName = "";
String urlName = "github.com/luizhavoc";
